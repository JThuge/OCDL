...
def get_args():
    parser = argparse.ArgumentParser(description="OCDL Args")
    ######################## general settings ########################
    ...
    ######################## extra settings to improve performace ########################
    parser.add_argument("--num_cls", type=int, default=2)
    parser.add_argument("--multi_cls_mask", default=False, action='store_true', help="whether to use mask-attn to train multi-cls model")
    ...
    ######################## loss settings ########################
    parser.add_argument("--loss_names", default='id+sadm', help="which loss to use ['mlm', 'id', 'sadm']")
    parser.add_argument("--mlm_loss_weight", type=float, default=1.0, help="mlm loss weight")
    parser.add_argument("--id_loss_weight", type=float, default=1.0, help="id loss weight")

    ######################## vison trainsformer settings ########################
    parser.add_argument("--img_size", type=tuple, default=(384, 160))
