...
class CUHKPEDES(BaseDataset):
    ...
    def __init__(self, root='', verbose=True):
        ...
        self.alpha_dir = op.join(self.dataset_dir, 'alphas3f_bag/')
    ...
    def _process_anno(self, annos: List[dict], training=False):
        ...
        if training:
            ...
            for anno in annos:
                ...
                alpha_path = op.join(self.alpha_dir, anno['file_path'])
                captions = anno['captions'] # caption list
                for caption in captions:
                    dataset.append((pid, image_id, img_path, alpha_path, caption))
                image_id += 1
